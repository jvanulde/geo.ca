...
var mod_pagespeed_bdF2$MH9vu = "document.querySelectorAll(\".col-theme-icons .elementor-icon\").forEach(link=>{link.addEventListener(\"focus\",()=>link.closest('.elementor-widget-container').classList.toggle(\"focus\"));link.addEventListener(\"blur\",()=>link.closest('.elementor-widget-container').classList.toggle(\"focus\"));});";
